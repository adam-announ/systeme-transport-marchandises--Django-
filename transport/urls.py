# transport/urls.py - Ordre corrigé pour éviter les conflits de routage
...
urlpatterns = [
    # 1. ROUTES PUBLIQUES SPÉCIFIQUES (à placer EN PREMIER)
    path('inscription/', views.inscription, name='inscription'),
    path('login/', auth_views.LoginView.as_view(template_name='registration/login.html'), name='login'),
    path('logout/', views.logout_view, name='logout'),
    path('home/', views.home_modern, name='home_modern'),
    
    # 2. ROUTES ADMIN (très spécifiques)
    ...
    # 7. PAGE D'ACCUEIL (à la fin pour éviter les conflits)
    path('', views.index, name='index'),  # Page d'accueil - DÉPLACÉE À LA FIN
]