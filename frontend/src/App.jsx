                ...
                <Routes>
                  ...
                  >
                    ...
                    >
                      ...
                      <Route path="commandes/:id/track" element={<TrackCommande />} />
                    </Route>

                    {/* Transporteur routes */}
                    <Route 
                      path="transporteur" 
                      element={<ProtectedRoute allowedRoles={['transporteur']} />}
                    >
                      <Route index element={<TransporteurDashboard />} />
                      <Route path="missions" element={<MissionList />} />
                      <Route path="navigation/:commandeId" element={<Navigation />} />
                    </Route>
                    ...
                    >
                      ...
                      <Route path="transporteurs" element={<TransporteurManagement />} />
                    ...
                    <Route 
                      path="planificateur" 
                      element={<ProtectedRoute allowedRoles={['planificateur']} />}
                    >
                      <Route index element={<PlanificateurDashboard />} />
